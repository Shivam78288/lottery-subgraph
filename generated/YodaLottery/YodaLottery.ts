...
export class YodaLottery__viewLotteryResultValue0Struct extends ethereum.Tuple {
  get status(): i32 {
    return this[0].toI32();
  }
  ...
  get TokenPerBracket(): Array<BigInt> {
  ...
  get amountCollectedInToken(): BigInt {
...
export class YodaLottery__viewNumbersAndStatusesForTicketIdsResult {
  value0: Array<BigInt>;
...
export class YodaLottery__viewUserInfoForLotteryIdResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class YodaLottery extends ethereum.SmartContract {
  static bind(address: Address): YodaLottery {
    return new YodaLottery("YodaLottery", address);
  }
  ...
  maxPriceTicketInToken(): BigInt {
    let result = super.call(
      "maxPriceTicketInToken",
      "maxPriceTicketInToken():(uint256)",
      []
    );
  ...
  try_maxPriceTicketInToken(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "maxPriceTicketInToken",
      "maxPriceTicketInToken():(uint256)",
      []
  ...
  minPriceTicketInToken(): BigInt {
    let result = super.call(
      "minPriceTicketInToken",
      "minPriceTicketInToken():(uint256)",
      []
    );
  ...
  try_minPriceTicketInToken(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "minPriceTicketInToken",
      "minPriceTicketInToken():(uint256)",
      []
  ...
  viewLottery(_lotteryId: BigInt): YodaLottery__viewLotteryResultValue0Struct {
    let result = super.call(
      "viewLottery",
    ...
    return changetype<YodaLottery__viewLotteryResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_viewLottery(
    _lotteryId: BigInt
  ): ethereum.CallResult<YodaLottery__viewLotteryResultValue0Struct> {
    let result = super.tryCall(
      "viewLottery",
      "viewLottery(uint256):((uint8,uint256,uint256,uint256,uint256,uint256[6],uint256,uint256[6],uint256[6],uint256,uint256,uint256,uint32))",
      [ethereum.Value.fromUnsignedBigInt(_lotteryId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<YodaLottery__viewLotteryResultValue0Struct>(value[0].toTuple())
    );
  }

  viewNumbersAndStatusesForTicketIds(
    _ticketIds: Array<BigInt>
  ): YodaLottery__viewNumbersAndStatusesForTicketIdsResult {
    let result = super.call(
      "viewNumbersAndStatusesForTicketIds",
    ...
    return new YodaLottery__viewNumbersAndStatusesForTicketIdsResult(
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new YodaLottery__viewNumbersAndStatusesForTicketIdsResult(
  ...
  viewUserInfoForLotteryId(
    ...
    _cursor: BigInt,
    _size: BigInt
  ): YodaLottery__viewUserInfoForLotteryIdResult {
    let result = super.call(
      "viewUserInfoForLotteryId",
    ...
    return new YodaLottery__viewUserInfoForLotteryIdResult(
      result[0].toBigIntArray(),
  ...
  try_viewUserInfoForLotteryId(
    ...
    _cursor: BigInt,
    _size: BigInt
  ): ethereum.CallResult<YodaLottery__viewUserInfoForLotteryIdResult> {
    let result = super.tryCall(
      "viewUserInfoForLotteryId",
      "viewUserInfoForLotteryId(address,uint256,uint256,uint256):(uint256[],uint32[],bool[],uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new YodaLottery__viewUserInfoForLotteryIdResult(
        value[0].toBigIntArray(),
...
export class SetMinAndMaxTicketPriceInTokenCall extends ethereum.Call {
  get inputs(): SetMinAndMaxTicketPriceInTokenCall__Inputs {
    return new SetMinAndMaxTicketPriceInTokenCall__Inputs(this);
  }

  get outputs(): SetMinAndMaxTicketPriceInTokenCall__Outputs {
    return new SetMinAndMaxTicketPriceInTokenCall__Outputs(this);
  }
}

export class SetMinAndMaxTicketPriceInTokenCall__Inputs {
  _call: SetMinAndMaxTicketPriceInTokenCall;

  constructor(call: SetMinAndMaxTicketPriceInTokenCall) {
    this._call = call;
  }

  get _minPriceTicketInToken(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get _maxPriceTicketInToken(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
}

export class SetMinAndMaxTicketPriceInTokenCall__Outputs {
  _call: SetMinAndMaxTicketPriceInTokenCall;
...
export class StartLotteryCall__Inputs {
  ...
  get _priceTicketInToken(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
